  ...
  return (
    <Container>
      <Row className="justify-content-center align-items-center text-center">
        <Col xs={6}>
          <h1 className="p-2 display-3">Profile</h1>
        </Col>
      </Row>
      <Row className="justify-content-center align-items-center">
        <Col xs={7} className="border border-primary-subtle rounded mt-3">
          <Form>
            ...
            <Form.Group as={Row} className="mb-3 mt-3" controlId="formPlaintextName">
              <Form.Label column sm="3">
                Имя
              </Form.Label>
              <Col sm="7">
